...
# load deployed model.
clf_model = pickle.load(open('deployed_xgb_model.sav',
                             'rb'
                             ))
generator_0 = pickle.load(open('class0_gmm_model.sav',
                               'rb'
                               ))
generator_1 = pickle.load(open('class1_gmm_model.sav',
                               'rb'
                               ))


# load static metrics.
model_metrics = pd.read_parquet('bootstrap_results.pq',
                                engine='pyarrow')
